export const surpriseMePrompts = [
  ...
  'shining leopard wearing a cyborg helmet, walking in snow, digital art',
  'Beautiful Sunrise over the lake surrounded by green trees',
];

export const POSTS_QUERY_KEY = ['posts', 'infinite'];
export const MY_FAVORITES_QUERY_KEY = ['favorite-posts', 'infinite'];
export const MY_COLLECTIONS_QUERY_KEY = ['my-posts', 'infinite'];
export const USER_QUERY_KEY = ['user'];

export const SEND_VERIFICATION_EMAIL_INFO =
  'Email verification success send to your email';
